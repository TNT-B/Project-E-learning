			...
			<>
				<footer className="footer-white">
					...
					<div className="footer-bottom">
						<div className="container">
							<div className="row">
								<div className="col-lg-12 col-md-12 col-sm-12 text-center"> © 2021 <span className="text-primary">Nguyễn Anh Khoa, Ninh Trung Tín - Lớp FE58</span>  All Rights Reserved.</div>
							</div>
						</div>
					</div>
				</footer>
